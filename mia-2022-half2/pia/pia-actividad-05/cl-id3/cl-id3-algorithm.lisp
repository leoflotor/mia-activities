...
(defvar *trees* nil "List of generated trees")
(defvar *results* nil "The results of ... ")
(defvar *main-class* nil "Main class from the voting system")
...
(defun induce (&optional (examples *examples*))
  "It induces the decision tree using learning setting"
