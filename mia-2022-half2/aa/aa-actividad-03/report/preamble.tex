...
\setmonofont{JuliaMono}[Path=./codefonts/, Extension=.ttf, UprightFont=*-Regular, ItalicFont=*-RegularItalic, Scale=0.85]

% These two commands to remove red boxes around special chars using minted
\renewcommand{\fcolorbox}[4][]{#4}          % in \inputminted
\AtBeginEnvironment{minted}{%               % in minted environment
...
\renewcommand\listingscaption{Algoritmo} % Rename listing caption
...
% -- Paths
\newcommand\codepath{../MandelbrotFractal/src/MandelbrotFractal.jl}
\newcommand\specsdiannao{../diannao-specs.txt}
% \newcommand\specshongdiannao{../hongdiannao-specs.txt}
