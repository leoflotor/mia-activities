...
\begin{figure}[ht!]
    \centering
    \includestandalone[scale=0.95, mode=buildnew]{../figures/diannao/time-diannao}
...
\begin{figure}[ht!]
    \centering
    \includestandalone[scale=0.95, mode=buildnew]{../figures/hongdiannao/time-hongdiannao}
